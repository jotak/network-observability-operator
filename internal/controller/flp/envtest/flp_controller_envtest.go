...
func ControllerSpecs(env test.Environment, ctxGetter test.ContextGetter) {
	...
	rbKeyHostNetworkMono := types.NamespacedName{Name: string(constants.HostNetworkRole)}
	rbKeyLokiWriterMono := types.NamespacedName{Name: string(constants.LokiWriterRole)}
	...
	rbKeyHostNetworkTransfo := types.NamespacedName{Name: string(constants.HostNetworkRole)}
	rbKeyLokiWriterTransfo := types.NamespacedName{Name: string(constants.LokiWriterRole)}
	rbKeyInformer := types.NamespacedName{Name: string(constants.FLPInformersRole)}
