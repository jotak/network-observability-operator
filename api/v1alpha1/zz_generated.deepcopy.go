...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConfigOrSecret) DeepCopyInto(out *ConfigOrSecret) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigOrSecret.
func (in *ConfigOrSecret) DeepCopy() *ConfigOrSecret {
	if in == nil {
		return nil
	}
	out := new(ConfigOrSecret)
	in.DeepCopyInto(out)
	return out
}
