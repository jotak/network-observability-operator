...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ConfigOrSecret)(nil), (*v1beta1.ConfigOrSecret)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ConfigOrSecret_To_v1beta1_ConfigOrSecret(a.(*ConfigOrSecret), b.(*v1beta1.ConfigOrSecret), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1beta1.ConfigOrSecret)(nil), (*ConfigOrSecret)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_ConfigOrSecret_To_v1alpha1_ConfigOrSecret(a.(*v1beta1.ConfigOrSecret), b.(*ConfigOrSecret), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*SASLConfig)(nil), (*v1beta1.SASLConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_SASLConfig_To_v1beta1_SASLConfig(a.(*SASLConfig), b.(*v1beta1.SASLConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1beta1.SASLConfig)(nil), (*SASLConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_SASLConfig_To_v1alpha1_SASLConfig(a.(*v1beta1.SASLConfig), b.(*SASLConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ConfigOrSecret_To_v1beta1_ConfigOrSecret(in *ConfigOrSecret, out *v1beta1.ConfigOrSecret, s conversion.Scope) error {
	out.Type = v1beta1.MountableType(in.Type)
	out.Name = in.Name
	out.Namespace = in.Namespace
...
// Convert_v1alpha1_ConfigOrSecret_To_v1beta1_ConfigOrSecret is an autogenerated conversion function.
func Convert_v1alpha1_ConfigOrSecret_To_v1beta1_ConfigOrSecret(in *ConfigOrSecret, out *v1beta1.ConfigOrSecret, s conversion.Scope) error {
	return autoConvert_v1alpha1_ConfigOrSecret_To_v1beta1_ConfigOrSecret(in, out, s)
}

func autoConvert_v1beta1_ConfigOrSecret_To_v1alpha1_ConfigOrSecret(in *v1beta1.ConfigOrSecret, out *ConfigOrSecret, s conversion.Scope) error {
	out.Type = MountableType(in.Type)
	out.Name = in.Name
	out.Namespace = in.Namespace
	out.Filename = in.Filename
...
// Convert_v1beta1_ConfigOrSecret_To_v1alpha1_ConfigOrSecret is an autogenerated conversion function.
func Convert_v1beta1_ConfigOrSecret_To_v1alpha1_ConfigOrSecret(in *v1beta1.ConfigOrSecret, out *ConfigOrSecret, s conversion.Scope) error {
	return autoConvert_v1beta1_ConfigOrSecret_To_v1alpha1_ConfigOrSecret(in, out, s)
}
...
func autoConvert_v1alpha1_FlowCollectorKafka_To_v1beta1_FlowCollectorKafka(in *FlowCollectorKafka, out *v1beta1.FlowCollectorKafka, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_SASLConfig_To_v1beta1_SASLConfig(&in.SASL, &out.SASL, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1beta1_FlowCollectorKafka_To_v1alpha1_FlowCollectorKafka(in *v1beta1.FlowCollectorKafka, out *FlowCollectorKafka, s conversion.Scope) error {
	...
	if err := Convert_v1beta1_SASLConfig_To_v1alpha1_SASLConfig(&in.SASL, &out.SASL, s); err != nil {
		return err
	}
	return nil
}
...
// Convert_v1alpha1_SASLConfig_To_v1beta1_SASLConfig is an autogenerated conversion function.
func Convert_v1alpha1_SASLConfig_To_v1beta1_SASLConfig(in *SASLConfig, out *v1beta1.SASLConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_SASLConfig_To_v1beta1_SASLConfig(in, out, s)
}
...
// Convert_v1beta1_SASLConfig_To_v1alpha1_SASLConfig is an autogenerated conversion function.
func Convert_v1beta1_SASLConfig_To_v1alpha1_SASLConfig(in *v1beta1.SASLConfig, out *SASLConfig, s conversion.Scope) error {
	return autoConvert_v1beta1_SASLConfig_To_v1alpha1_SASLConfig(in, out, s)
}
