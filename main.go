...
func main() {
	...
	flag.StringVar(&config.WebConsoleImage, "web-console-image", "quay.io/netobserv/network-observability-console-plugin:main", "The image of the Web Console (standalone or plugin)")
